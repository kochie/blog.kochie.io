  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Head>
        ...
        <link
          rel="icon"
          href="/static/images/blog-logo-128.png"
          sizes="128x128"
          type="image/png"
        />
        <link
          rel="icon"
          href="/static/images/blog-logo-192.png"
          sizes="192x192"
          type="image/png"
        />
        <link
          rel="icon"
          href="/static/images/blog-logo-512.png"
          sizes="512x512"
          type="image/png"
        />
          ...
          <div className={style.titles}>
            <div>
              <img
                width={192}
                height={192}
                src={'/static/images/blog-logo.svg'}
