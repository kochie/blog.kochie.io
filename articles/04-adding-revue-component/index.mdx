...
> **Update (January 2023):** Twitter shut down Revue on January 18, 2023. The
> service is no longer available. This article is preserved as a historical
> reference; links to getrevue.co point to archived snapshots.

I recently started writing a newsletter as a way of keeping track of what I'm
doing week to week. I've been using [Revue](https://web.archive.org/web/20221201000000/https://www.getrevue.co/) to write
...
[getrevue.co](https://web.archive.org/web/20221201000000/https://www.getrevue.co/) and create an account and link with your
Twitter account.
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6 md:col-span-4 my-auto">
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href="https://web.archive.org/web/20221201000000/https://www.getrevue.co/terms"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href="https://web.archive.org/web/20221201000000/https://www.getrevue.co/privacy"
                className="underline text-orange-500 hover:text-orange-600 transform duration-200"
              >
                Privacy Policy
              </a>
