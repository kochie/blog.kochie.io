...
Additionally, if you want the new `Image` functionality you can run the following
...
which uses a completely new layout system. Now it's possible to
...
performance of the package will improve.
...
Initially I was stuck on how I would implement mdx rendering with the new system.
...
The real advantage of using layouts is the ability to interact with the React Suspense pattern and 
