...
The real advantage of using layouts is the ability to interact with the React
Suspense pattern and render different parts of a page while other parts are
still loading, allowing for a more dynamic and interactive experience.
