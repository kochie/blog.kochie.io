...
artificial gravity. The idea has been around for decades now, you've probably
seen the giant ringed spacecraft in movies slowly rotating. If a large enough
spacecraft rotates a habitation ring around it can produce a force similar to
gravity
...
Using only currently known methods there are two ways to create a force like
gravity, mass and rotational intertia.
